...
var _initialiseProps = function _initialiseProps() {
  ...
  this.dragEnd = function () {
    var index = _this2.state.tree.getIndex(_this2.state.dragging.id);
    var parent = index ? _this2.state.tree.get(index.parent) : null;
    var node = index ? index.node : null;
    ...
    _this2.change(_this2.state.tree, parent, node);
